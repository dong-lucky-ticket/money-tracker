...
final List<CategoryIconGroup> categoryIconGroups = [
  ...
  CategoryIconGroup(
      '其它', ['gift-outline', 'heart-outline', 'paw', 'help-circle-outline']),
];
